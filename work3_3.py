...
#одно слово, которое содержит либо только английские, либо только русские буквы.   Ввод: ноутбук  Вывод: 12

score = {1: 'АВЕИНОРСТ', 2: 'ДЛМКПУ', 3: 'БГЁЬЯ', 4: 'ЙЫ', 5: 'ЖЗХЦЧ', 8: 'ШЭЮ' ,10: 'ФЩЪ'}

word = str(input("Введите русское слово кириллицей: ")).upper()
res = 0
for item in word:
